                ...
                <section id="party" class="mt-12 m-auto -space-y-4 items-center justify-center md:flex md:space-y-0 md:-space-x-4 xl:w-10/12">
                        <div class="relative z-10 -mx-4 group md:w-9/12 md:mx-0 lg:w-9/12">
                            ...
                            <div class="relative p-6 space-y-6 lg:p-8">
                                <h3 class="text-3xl text-gray-700 font-semibold text-center">01⏤ Party Makeup Service</h3>
                                <div>
                                    <img src=" {{ asset('images/service/party1.jpg') }}"  alt="Promotional Image" class="w-full h-auto rounded-2xl">
                                </div>
                            ...
                            <div class="relative p-8 pt-16 md:p-8 md:pl-6 md:rounded-r-2xl lg:p-16">
                                ...
                                <ul role="list" class="space-y-4 mt-2 mb-2 lg:py-6 lg:px-4 italic mx-auto text-gray-950 lg:pl-32 p-12 text-left justify-center">
                                    <li class="space-x-2">
                                        ...
                                        <span> CUSTOM MAKEUP</span>
                                    </li>
                                    <li class="space-x-2">
                                        <span class="text-orange-700 font-semibold">&check;</span>
                                        <span>COUTURE HAIR STYLING</span>
                                    </li>
                                    <li class="space-x-2">
                                        <span class="text-orange-700 font-semibold">&check;</span>
